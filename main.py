...
if __name__ == '__main__':
    ...
    parser.add_argument('--D', type=int, default=41, help='num grid of zeta axis')
    parser.add_argument('--scaling_factor', type=int, default=800, help='entry value for existence of pts')
    parser.add_argument('--upsampling_factor', type=int, default=1, help='grid dim=[H,W]*upsampling_factor')
    # train info
    ...
    parser.add_argument('--batch_size', type=int, default=16, help='when training on multi GPU, is the batch size on each GPU')
    ...
    # for nonconvex loss
    parser.add_argument('--port', type=str, default='16026', help='DDP master port')
    parser.add_argument('--weight', type=str, default=None, help='lambda CEL0')
    parser.add_argument('--background', type=float, default=10)
    parser.add_argument('--extra_loss', type=str, default='forwardKL_klnc_mse3d', help='indicate whether use cel0 for gaussian or nc for possion')
    # for extra losses
    parser.add_argument('--cel0_mu', type=float, default=1, help='mu in cel0 loss')
    parser.add_argument('--klnc_a', type=float, default=1000, help='a for nonconvex loss in KLNC')
