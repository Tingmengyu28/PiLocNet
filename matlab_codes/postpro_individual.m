...
zmax = 20;
%forward w0.0000001
% pred_path_base = '/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-01-07-09-29-50-w1_1_0-mse3d_klnc_forward-1e-5-D250';
%forward w0.000001
% pred_path_base = '/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-01-06-08-49-45-w1_1_0-mse3d_klnc_forward-1e-5-D250';
% forward w0.0001
% pred_path_base = '/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-01-03-21-52-09-w1_1_0-mse3d_klnc_forward-1e-5-D250';
% forward w0
% pred_path_base = '/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2022-12-30-23-24-10-w1_0_0-mse3d_klnc_forward-1e-5-D250';
%forward+nc
% pred_path_base='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-02-06-23-38-39-w0_1_1-mse3d_klnc_forward-1e-5-D250';
%forward_only
%pred_path_base='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-02-09-15-07-28-w0_0_1-mse3d_klnc_forward-1e-5-D250';
%forward_klnc10000
% pred_path_base = '/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-02-17-22-43-26-w0_1_1-mse3d_klnc_forward-1e-5-D250';
%forward_only+0.05alpha
%pred_path_base ='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-02-16-15-43-54-w0_0_1-mse3d_klnc_forward-1e-5-D250';
%forward_only
%pred_path_base='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-02-09-15-07-28-w0_0_1-mse3d_klnc_forward-1e-5-D250';
%mse3d_forward_klnc
%pred_path_base='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-02-20-17-38-48-w1000_1_1-mse3d_klnc_forward-1e-5-D250';
%mse3d_forward_klnc 100_1_1
%pred_path_base='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-02-19-23-23-27-w100_1_1-mse3d_klnc_forward-1e-5-D250'
% pred_path_base='/home/to1nielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-03-20-09-01-05-w1_10_1000-forward_klnc_mse3d-1e-5-D250'
%PINND4150K
pred_path_base='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-03-27-23-26-18-w1_10_1000-forward_klnc_mse3d-1e-5-D250'
%PINND250initial
%pred_path_base='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-04-06-08-57-39-w1_1_4000-forward_klnc_mse3d-1e-5-D250'
%gaussian
% pred_path_base='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-04-16-09-32-28-w1_10_1000-forward_klnc_mse3d-1e-5-D250'
%poisson
%pred_path_base='/home/to1nielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-03-20-16-34-02-w1_10_1000-forward_klnc_mse3d-1e-5-D250'
%D250mse10k
% pred_path_base='/home/tonielook/rpsf/20221204_LocNet_LossTunning/test_output/2023-04-12-19-16-14-w1_2_10000-forward_klnc_mse3d-1e-5-D250'
mat_path_base = '/home/tonielook/rpsf/20221204_LocNet_LossTunning/data_test_poisson';
view = 1; % plot
save_pred_info = 0; % Save pred_label.csv & eval.csv
...
for nsource_idx = 1:length(nsources)
   ...
   mat_path = fullfile(mat_path_base,['test',num2str(nSource)],'noise');
    ...
    for nt = 1:3
        ...
        if view
            I0 = load(fullfile(mat_path,sprintf('im%d.mat',nt)));
            I0 = I0.g;
        end
        ...
        if view
            ...
            plot3(gt_tmp(:,2)+Np/2,gt_tmp(:,3)+Np/2,(gt_tmp(:,4)+21)/2.1+1,'ro', pred_tmp(:,2)+Np/2,pred_tmp(:,3)+Np/2,(pred_tmp(:,4)+21)/2.1+1,'bx');
            title(sprintf('Initial Prediction %d', nt))
            axis([0 Np 0 Np 0 21]); grid on
        ...
        for i = 1 : nPred
            ...
            ylow = min(96,round1(49+Vpred(i+nPred)));
%             zlow = round((Vpred(i+2*nPred)+21)/2.1);
            zlow = min(round((Vpred(i+2*nPred)+21)/2.1)+1,21);
